    ...
    <form name="mediaForm" ng-submit="save($event)" style="overflow: hidden" >
        ...
        <md-dialog-content style="    height: 100%;    max-height: 600px;    overflow-y: scroll;    width: 100%;">
        	<div class="photo-uploading">
        		<div class="photo-container" style="background-image:url('<% uploadingFile.src %>')"
        			layout="row" layout-align="center center"
        			ng-click="chooseFile($event)">
        			<span ng-show="uploadFile.obj != null" class="">Select a file to upload</span>
        		</div>
        	</div>
        	<div>
		        ...
		        <md-input-container flex>
		            ...
		            <input type="text" ng-model="data.link" name="caption">    
		        </md-input-container>
		        ...
		        <md-checkbox ng-model="data.is_home_image" class="md-primary" style="margin: 0px;">
        ...
        <div class="md-actions">
        	<div ng-if="mode == 'create'"  layout="row" 
        		layout-align="space-between center" style="width: 100%">							
	        	<md-button 
	        		type="button"
			...
			<div ng-if="mode == 'edit'" layout="row" 
				layout-align="space-between center" style="width: 100%">	
				{{-- <div> --}}
