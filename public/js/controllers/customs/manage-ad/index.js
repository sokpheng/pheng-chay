(function (){
	app.controller('AdvertisementListingCtrl', ['$scope', '$timeout', '$mdSidenav',
	    ...
	    function loadData(callback, offset, limit){
			...
			CoResource.resources.Advertisement.list({
	    ...
	    $scope.viewDetail = function (item){
	    	$location.path('advertisements/' + item._id);
	    };
	  ...
	  //   	$rootScope.loading('show');
		...
		$scope.createAdvertisement = function (){
			$location.path('advertisements/create');
		};
